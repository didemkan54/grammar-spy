(function(){
  const map = {
    header: 'components/header.html?v=20260225b',
    footer: 'components/footer.html?v=20260225b',
    sidebar: 'components/sidebar.html?v=20260225b'
  };
  ...
  var headerFallback = '<nav aria-label="Primary navigation" style="margin:0 auto 16px;max-width:1120px;padding:8px 2px 12px;display:flex;justify-content:space-between;align-items:center;gap:20px;flex-wrap:wrap;border-bottom:1px solid #d9dee6;background:#ffffff">' +
    '<a href="index.html" style="text-decoration:none;color:#16223a;display:inline-flex;align-items:center;background:transparent"><img src="assets/brand/logo-primary.svg?v=20260225b" alt="Grammar Spy™" style="height:72px;width:auto;display:block;background:transparent;border:none"></a>' +
    ...
    '<a href="missions.html" style="text-decoration:none;color:#4a5568;font:700 13px Inter,Arial,sans-serif;letter-spacing:.08em;text-transform:uppercase">Mission Library</a>' +
    '<a href="progression.html" style="text-decoration:none;color:#4a5568;font:700 13px Inter,Arial,sans-serif;letter-spacing:.08em;text-transform:uppercase">Training Path</a>' +
    '<a href="profile.html" style="text-decoration:none;color:#4a5568;font:700 13px Inter,Arial,sans-serif;letter-spacing:.08em;text-transform:uppercase">Profile</a>' +
