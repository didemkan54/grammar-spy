...
- To test in-browser: `python3 -m http.server 8080` from repo root, then visit e.g. `http://localhost:8080/error-smash?play_format=teams` or `?play_format=whole_class`.
